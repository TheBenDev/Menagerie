...
const AudioCueDataScript := preload("res://core/audio/audio_cue_data.gd")
const AudioRegistryScript := preload("res://core/audio/audio_registry.gd")

const DEFAULT_LIBRARY_PATH := "res://assets/audio/common_audio_library.tres"
const DEFAULT_SOUND_ROOT_PATH := "res://assets/audio"
...
func has_audio_stream(id: StringName) -> bool:
	return _audio_registry.has_stream(id)
