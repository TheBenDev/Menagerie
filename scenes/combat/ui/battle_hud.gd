...
const CombatantPanelScript := preload("res://scenes/combat/ui/combatant_panel.gd")
const BattleActionBarScript := preload("res://scenes/combat/ui/action_bar.gd")
const ActionQueuePanelScript := preload("res://scenes/combat/ui/action_queue_panel.gd")
